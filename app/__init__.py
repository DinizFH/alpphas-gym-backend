...
from app.administrador.logs_admin_routes import logs_admin_bp
...
def create_app():
    ...
    app.config["MAIL_DEFAULT_SENDER"] = os.getenv("MAIL_DEFAULT_SENDER", "Alpphas GYM <noreply@alpphasgym.com>")
